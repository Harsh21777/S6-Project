...
def get_allocation(nodes_data, services_data, app):
    ...
    for k in range(MAX_TRIALS):
        ...
        # Initializes variables to store the best allocation
        best_allocations = []
        ...
        for t in range(T):
            #Recreates the data to maintain independence between runs
            ...
            # Initializes lists for each run
            allocated_nodes = []
            allocated_services = []
            allocations = []

            # Shuffles the services
        ...
        # Calculates the average utilization and its standard deviation
